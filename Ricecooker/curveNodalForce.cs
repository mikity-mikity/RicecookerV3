...
namespace mikity.ghComponents
{
    ...
    /// </summary>
    public class curve_nodal_force : Grasshopper.Kernel.GH_Component
    {
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                System.IO.Stream st = myAssembly.GetManifestResourceStream("mikity.ghComponents.icons.curve-nodal_forces.bmp");
                //指定されたマニフェストリソースを読み込む
                System.Drawing.Bitmap bmp = new System.Drawing.Bitmap(st);
                return bmp;
            }
        }
        public curve_nodal_force()
            : base("curve->nodalForce [Nodal Force]", "curve->nodalForce", "curve->nodalForce (Constraint condition)", "Ricecooker", "Super market")
        {
        }
        ...
        {
            get { return new Guid("9c23f7c8-942e-417a-9140-968c33a35902"); }
        }
