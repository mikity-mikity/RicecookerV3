...
namespace mikity.ghComponents
{
    ...
    /// </summary>
    public class two_nodes_total_length : Grasshopper.Kernel.GH_Component
    {
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                System.IO.Stream st = myAssembly.GetManifestResourceStream("mikity.ghComponents.icons.two-nodes-total_length.bmp");
        ...
        public two_nodes_total_length()
            : base("2nodes->totalLength [Constraint Condition]", "2nodes->totalLength", "2nodes->totalLength (Constraint condition)", "Ricecooker", "Convenience store")
        {
        }
        ...
        public DrawViewPortWire GetDVPW(Rhino.Geometry.Polyline m)
        {
            return new DrawViewPortWire((args) =>
            {
                ...
                {
                    args.Display.DrawPolyline(m, System.Drawing.Color.Red, 4);
                }
                else
                {
                    args.Display.DrawPolyline(m, System.Drawing.Color.DarkMagenta, 4);
                }
                base.DrawViewportWires(args);
        ...
        {
            get { return new Guid("bc04a03e-b343-4206-8739-f2717e91530b"); }
        }
